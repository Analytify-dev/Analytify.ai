    ...
    def handle(self, *args, **options):
        ...
        sheetFilterQuerySetData= [
            ...
            },
            {
                ...
                "custom_query": """SELECT COUNT(\"attrition\") AS \"count(attrition)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table WHERE \"attrition\" IN ('Yes')"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },                
            {
                ...
                "columns": [],
                "rows": ['"count(attrition)"'],
                "custom_query": """SELECT COUNT(\"attrition\") AS \"count(attrition)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table WHERE \"attrition\" IN ('No')"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },
            {
                ...
                "custom_query": """SELECT MAX(\"hourly_rate\") AS \"max(hourly_rate)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table"
                                """,
                 "updated_at":datetime.datetime.now()
            },                
            {
                ...
                "columns": [],
                "rows": ['"count(gender)"'],
                "custom_query": """SELECT COUNT(\"gender\") AS \"count(gender)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table WHERE \"gender\" IN ('Male')"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },
            {
                ...
                "columns": [],
                "rows": ['"count(gender)"'],
                "custom_query": """SELECT COUNT(\"gender\") AS \"count(gender)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table WHERE \"gender\" IN ('Female')"
                                """,
                "updated_at":datetime.datetime.now()
            },                
            {
                ...
                "custom_query": """SELECT \"job_role\" AS \"job_role\", COUNT(\"id\") AS \"count(id)\", AVG(\"age\") AS \"avg(age)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table GROUP BY \"job_role\", \"job_role\"
                                """,
                "updated_at":datetime.datetime.now()
            },
            {
                ...
                "columns": [' "department"'],
                "rows": ['"count(id)"'],
                "custom_query": """SELECT \"department\" AS \"department\", COUNT(\"id\") AS \"count(id)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table GROUP BY \"department\", \"department\"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },                
            {
                ...
                "rows": ['"count(id)"'],
                "custom_query": """SELECT \"marital_status\" AS \"marital_status\", COUNT(\"id\") AS \"count(id)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table GROUP BY \"marital_status\", \"marital_status\"
                                    """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },
            {
                ...
                "custom_query": """SELECT \"attrition\" AS \"attrition\", SUM(\"years_at_company\") AS \"sum(years_at_company)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table GROUP BY \"attrition\", \"attrition\"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },            
            {
                ...
                "rows": ['"count(id)"'],
                "custom_query": """SELECT \"education_field\" AS \"education_field\", COUNT(\"id\") AS \"count(id)\" FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table WHERE \"attrition\" IN ('Yes') GROUP BY \"education_field\", \"education_field\"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },
            {
                ...
                "rows": [],
                "custom_query": """SELECT \"id\" AS \"id\", \"attrition\" AS \"attrition\", \"business_travel\" AS \"business_travel\", \"department\" AS \"department\", \"education_field\" AS \"education_field\", \"gender\" AS \"gender\", \"job_role\" AS \"job_role\", \"marital_status\" AS \"marital_status\", \"hourly_rate\" AS \"hourly_rate\" 
                                FROM (SELECT \"hr_attrition\".\"id\" AS \"id\", \"hr_attrition\".\"age\" AS \"age\", \"hr_attrition\".\"attrition\" AS \"attrition\", \"hr_attrition\".\"business_travel\" AS \"business_travel\", \"hr_attrition\".\"daily_rate\" AS \"daily_rate\", \"hr_attrition\".\"department\" AS \"department\", \"hr_attrition\".\"distance_from_home\" AS \"distance_from_home\", \"hr_attrition\".\"education\" AS \"education\", \"hr_attrition\".\"education_field\" AS \"education_field\", \"hr_attrition\".\"environment_satisfaction\" AS \"environment_satisfaction\", \"hr_attrition\".\"gender\" AS \"gender\", \"hr_attrition\".\"hourly_rate\" AS \"hourly_rate\", \"hr_attrition\".\"job_involvement\" AS \"job_involvement\", \"hr_attrition\".\"job_level\" AS \"job_level\", \"hr_attrition\".\"job_role\" AS \"job_role\", \"hr_attrition\".\"job_satisfaction\" AS \"job_satisfaction\", \"hr_attrition\".\"marital_status\" AS \"marital_status\", \"hr_attrition\".\"monthly_income\" AS \"monthly_income\", \"hr_attrition\".\"monthly_rate\" AS \"monthly_rate\", \"hr_attrition\".\"num_companies_worked\" AS \"num_companies_worked\", \"hr_attrition\".\"over18\" AS \"over18\", \"hr_attrition\".\"over_time\" AS \"over_time\", \"hr_attrition\".\"percent_salary_hike\" AS \"percent_salary_hike\", \"hr_attrition\".\"performance_rating\" AS \"performance_rating\", \"hr_attrition\".\"relationship_satisfaction\" AS \"relationship_satisfaction\", \"hr_attrition\".\"standard_hours\" AS \"standard_hours\", \"hr_attrition\".\"stock_option_level\" AS \"stock_option_level\", \"hr_attrition\".\"total_working_years\" AS \"total_working_years\", \"hr_attrition\".\"training_times_last_year\" AS \"training_times_last_year\", \"hr_attrition\".\"work_life_balance\" AS \"work_life_balance\", \"hr_attrition\".\"years_at_company\" AS \"years_at_company\", \"hr_attrition\".\"years_in_current_role\" AS \"years_in_current_role\", \"hr_attrition\".\"years_since_last_promotion\" AS \"years_since_last_promotion\", \"hr_attrition\".\"years_with_current_manager\" AS \"years_with_current_manager\" 
                                FROM \"In Ex\".\"hr_attrition\" AS \"hr_attrition\") temp_table 
                                GROUP BY \"id\", \"attrition\", \"business_travel\", \"department\", \"education_field\", \"gender\", \"job_role\", \"marital_status\", \"hourly_rate\", \"id\", \"attrition\", \"business_travel\", \"department\", \"education_field\", \"gender\", \"job_role\", \"marital_status\", \"hourly_rate\"
                                """,
                "created_at":datetime.datetime.now(),
                "updated_at":datetime.datetime.now()
            },
        ...
        try:
            ...
            for index, item in enumerate(data):
                ...
                item['hierarchy_id'] = hierarchy_id
                item['qrySetId'] = querysetid.queryset_id

            # Upload the JSON file to S3
            file_url,output_file_key = create_s3_file(input_file_path, sheet_ids_list, hierarchy_id, querysetid, settings.AWS_STORAGE_BUCKET_NAME)
