...
def relation1(tables, table_col, dbtype, join_conditions, new_joining_cond):
    try:
        ...
        for table1, table2 in combinations(tables, 2):
            ...
            dict1 = {col.split(':')[0]:col.split(':')[1] for col in list_of_tables[table1]}
            dict2 = { col.split(':')[0]:col.split(':')[1] for col in list_of_tables[table2]}
    ...
    def post(self,request,token):
        ...
        if tok1['status']==200:
            ...
            if len(joining_tables) ==0:
                ...
                responce = building_query1(self,joining_tables,join_table_conditions,join_type,engine,dbtype,new_join_table_conditions)
                try:
