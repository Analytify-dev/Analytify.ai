    ...
    def handle(self, *args, **options):
        ...
        sheetFilterQuerySetData = [
            {
                ...
                "columns": [],
                "rows": ['"count(order_id)"'],
                "custom_query": """SELECT COUNT(\"order_id\") AS \"count(order_id)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table
                                    """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            },
            {
                ...
                "custom_query": """SELECT COUNT(DISTINCT \"supplier_id\") AS \"CNTD(supplier_id)\" 
                                    FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                    FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table
                                """,
                "created_at": datetime.datetime.now(),
            ...
            },
            {
                ...
                "custom_query": """SELECT COUNT(DISTINCT \"product_id\") AS \"CNTD(product_id)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table
                                    """,
                "created_at": datetime.datetime.now(),
            ...
            },
            {
                ...
                "custom_query": """SELECT SUM(\"quantity_received\") AS \"sum(quantity_received)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table
                                    """,
                "created_at": datetime.datetime.now(),
            ...
            },
            {
                ...
                "rows": ['"sum(total_cost)"'],
                "custom_query": """SELECT 
                                        STRFTIME('%Y', CAST(\"order_date\" AS DATE)) AS \"year(order_date)\",  -- Extract the year from the date
                                        SUM(\"total_cost\") AS \"sum(total_cost)\"
                                    FROM 
                                        (SELECT 
                                            \"supply_chain\".\"order_id\" AS \"order_id\", 
                                        ...
                                        FROM 
                                            \"main\".\"supply_chain\" AS \"supply_chain\") temp_table 
                                    GROUP BY 
                                        STRFTIME('%Y', CAST(\"order_date\" AS DATE))
                                    """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            },
            {
                ...
                "custom_query": """SELECT \"warehouse_location\" AS \"warehouse_location\", SUM(\"quantity_ordered\") AS \"sum(quantity_ordered)\", SUM(\"quantity_received\") AS \"sum(quantity_received)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table 
                                        GROUP BY \"warehouse_location\", \"warehouse_location\"
                                    """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            },
            {
                ...
                "rows": ['"sum(total_cost)"'],
                "custom_query": """SELECT \"product_category\" AS \"product_category\", SUM(\"total_cost\") AS \"sum(total_cost)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table 
                                        GROUP BY \"product_category\", \"product_category\"
                                """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            },
            {
                ...
                "custom_query": """SELECT \"supplier_name\" AS \"supplier_name\", AVG(\"supplier_rating\") AS \"avg(supplier_rating)\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table 
                                        GROUP BY \"supplier_name\", \"supplier_name\"
                                    """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            },
            
            {
                ...
                "rows": [],
                "custom_query": """SELECT \"order_id\" AS \"order_id\", \"product_id\" AS \"product_id\", \"product_name\" AS \"product_name\", \"product_category\" AS \"product_category\", \"total_cost\" AS \"total_cost\", \"shipping_cost\" AS \"shipping_cost\" 
                                        FROM (SELECT \"supply_chain\".\"order_id\" AS \"order_id\", \"supply_chain\".\"order_date\" AS \"order_date\", \"supply_chain\".\"supplier_id\" AS \"supplier_id\", \"supply_chain\".\"supplier_name\" AS \"supplier_name\", \"supply_chain\".\"product_id\" AS \"product_id\", \"supply_chain\".\"product_name\" AS \"product_name\", \"supply_chain\".\"product_category\" AS \"product_category\", \"supply_chain\".\"quantity_ordered\" AS \"quantity_ordered\", \"supply_chain\".\"quantity_received\" AS \"quantity_received\", \"supply_chain\".\"order_status\" AS \"order_status\", \"supply_chain\".\"lead_time_days\" AS \"lead_time_days\", \"supply_chain\".\"cost_per_unit\" AS \"cost_per_unit\", \"supply_chain\".\"total_cost\" AS \"total_cost\", \"supply_chain\".\"shipping_cost\" AS \"shipping_cost\", \"supply_chain\".\"warehouse_location\" AS \"warehouse_location\", \"supply_chain\".\"inventory_level\" AS \"inventory_level\", \"supply_chain\".\"backorder_status\" AS \"backorder_status\", \"supply_chain\".\"delivery_date\" AS \"delivery_date\", \"supply_chain\".\"supplier_rating\" AS \"supplier_rating\", \"supply_chain\".\"order_comments\" AS \"order_comments\" 
                                        FROM \"main\".\"supply_chain\" AS \"supply_chain\") temp_table 
                                        GROUP BY \"order_id\", \"product_id\", \"product_name\", \"product_category\", \"total_cost\", \"shipping_cost\", \"order_id\", \"product_id\", \"product_name\", \"product_category\", \"total_cost\", \"shipping_cost\"
                                    """,
                "created_at": datetime.datetime.now(),
                "updated_at": datetime.datetime.now()
            }
        ...
        try:
            ...
            input_file_path = os.path.join(BASE_DIR, 'dashboard', 'management', 'commands', 'dashboard',
                                           'Dashboard-SupplyChain.txt')  # Replace with your actual .txt file name
            ...
            image_image_path = os.path.join(BASE_DIR, 'dashboard', 'management', 'commands',
                                            'dashboard', 'images', '2024-11-14_11_48_44.4835771731565123393.jpeg')
        ...
        dashboardSampleData = {
            ...
            "dashboard_tag_name": """<p style="text-align:center;"><span style="font-size:16px;"><strong>New</strong></span> <span style="font-size:16px;"><strong>Supply Chain Dashboard</strong></span></p>""",
            "is_public": False,
            "created_at": datetime.datetime.now(),
            "updated_at": datetime.datetime.now()
        }
