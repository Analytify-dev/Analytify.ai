...
from .Filters import (rdbmsjoins,joining_query_data,Chart_filter,Multicolumndata_with_filter,alias_attachment,DataSource_Data_with_Filter,
                      ...
                      sheet_delete_stmt,query_delete_stmt,get_datasource,dashboard_drill_down,data_table_chart,dashboard_table_chart)
...
urlpatterns = [
    ...
    path('calc_data/<int:cal_id>/<token>',Calculation.cal_field_data,name='data calculation field'), #['GET']
    ...
    path('new_dashboard_reassign',views.new_dashboard_reassign,name="Reassign New Dashboard to all Users"),
